        ...
        >
          <SwiperSlide>
            ...
            <div className="p-container">
              ...
              <p className="pastors-label-2">Ptra. Edna Te</p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            ...
            <div className="p-container">
              ...
              <p className="pastors-label-2 ">Ptr. Ruden Barcelona</p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            ...
            <div className="p-container">
              ...
              <p className="pastors-label-2 ">Ptra. Almira Zonio</p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            ...
            <div className="p-container">
              ...
              <p className="pastors-label-2">Ptra. Edna Heraldo</p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            ...
            <div className="p-container">
              ...
              <p className="pastors-label-2 ">Ptr. Ronald Zonio</p>
            </div>
          </SwiperSlide>
        </Swiper>
      </div>
